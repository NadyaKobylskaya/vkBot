...
async def handle_callback(event: dict):
    ...
    # ---- Задание 6: Обыкновенные дроби ----
        ...
        await send_photo(peer_id, "app/rules_n6_ordinary_fractions.jpg")
    ...
    # ---- Задание 12 ----
        ...
        await send("📖 Справочник по заданию 12 скоро будет добавлен.")
    ...
    # ---- Задание 14 ----
        ...
        await send("📖 Справочник по арифметической прогрессии скоро будет добавлен.")

    elif cmd == "show_right_geom_prog":
        await send(f"Правильный ответ: {get_answer(user_id) or 'не найден'}")
    elif cmd == "show_help_geom_prog":
        await send("📖 Справочник по геометрической прогрессии скоро будет добавлен.")
    ...
    # ---- Задание 19 ----
        ...
        await send("📖 Справочник по заданию 19 скоро будет добавлен.")
    ...
    elif cmd == "show_right_n22":  await send(f"Правильный ответ: {get_answer(user_id) or 'не найден'}")
