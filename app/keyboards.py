...
oge_algebra = (
    ...
    .row()
    .add(Callback("Задание 6", {"cmd": "n6"}))
    .add(Callback("Задание 7", {"cmd": "n7"}))
    .add(Callback("Задание 8", {"cmd": "n8"}))
    .row()
...
oge_algebra2 = (
    Keyboard(inline=True)
    .add(Callback("Задание 9",  {"cmd": "n9"}))
    .add(Callback("Задание 10", {"cmd": "n10"}))
    .add(Callback("Задание 11", {"cmd": "n11"}))
    .row()
    .add(Callback("Задание 12", {"cmd": "n12"}))
    .add(Callback("Задание 13", {"cmd": "n13"}))
    .add(Callback("Задание 14", {"cmd": "n14"}))
    .row()
...
oge_geo = (
    Keyboard(inline=True)
    .add(Callback("Задание 15", {"cmd": "n15"}))
    .add(Callback("Задание 16", {"cmd": "n16"}))
    .add(Callback("Задание 17", {"cmd": "n17"}))
    .row()
    .add(Callback("Задание 18", {"cmd": "n18"}))
    .add(Callback("Задание 19", {"cmd": "n19"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "oge_part1"}))
    .get_json()
)
...
oge_part2 = (
    Keyboard(inline=True)
    .add(Callback("Задание 20", {"cmd": "n20"}))
    .add(Callback("Задание 21", {"cmd": "n21"}))
    .add(Callback("Задание 22", {"cmd": "n22"}))
    .row()
    .add(Callback("Задание 23", {"cmd": "n23"}))
    .add(Callback("Задание 24", {"cmd": "n24"}))
    .add(Callback("Задание 25", {"cmd": "n25"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "back_to_tasks_oge"}))
    .row()
    .add(Callback("🧠 AI Help",      {"cmd": "ai_help"}),   color=KeyboardButtonColor.POSITIVE)
...
ege_base1 = (
    Keyboard(inline=True)
    .add(Callback("Задание 1", {"cmd": "e1"}))
    .add(Callback("Задание 2", {"cmd": "e2"}))
    .add(Callback("Задание 3", {"cmd": "e3"}))
    .row()
    .add(Callback("Задание 4", {"cmd": "e4"}))
    .add(Callback("Задание 5", {"cmd": "e5"}))
    .row()
    .add(Callback("Задание 6", {"cmd": "e6"}))
    .add(Callback("Задание 7", {"cmd": "e7"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "ege_base"}))
    .get_json()
)

# ЕГЭ База — задания 8–14
ege_base2 = (
    Keyboard(inline=True)
    .add(Callback("Задание 8",  {"cmd": "e8"}))
    .add(Callback("Задание 9",  {"cmd": "e9"}))
    .add(Callback("Задание 10", {"cmd": "e10"}))
    .row()
    .add(Callback("Задание 11", {"cmd": "e11"}))
    .add(Callback("Задание 12", {"cmd": "e12"}))
    .add(Callback("Задание 13", {"cmd": "e13"}))
    .add(Callback("Задание 14", {"cmd": "e14"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "ege_base"}))
    .get_json()
)

# ЕГЭ База — задания 15–21
ege_base3 = (
    Keyboard(inline=True)
    .add(Callback("Задание 15", {"cmd": "e15"}))
    .add(Callback("Задание 16", {"cmd": "e16"}))
    .add(Callback("Задание 17", {"cmd": "e17"}))
    .row()
    .add(Callback("Задание 18", {"cmd": "e18"}))
    .add(Callback("Задание 19", {"cmd": "e19"}))
    .add(Callback("Задание 20", {"cmd": "e20"}))
    .add(Callback("Задание 21", {"cmd": "e21"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "ege_base"}))
    .get_json()
)
...
ege_p_part1 = (
    Keyboard(inline=True)
    .add(Callback("Задание 1", {"cmd": "p1"}))
    .add(Callback("Задание 2", {"cmd": "p2"}))
    .add(Callback("Задание 3", {"cmd": "p3"}))
    .row()
    .add(Callback("Задание 4", {"cmd": "p4"}))
    .add(Callback("Задание 5", {"cmd": "p5"}))
    .add(Callback("Задание 6", {"cmd": "p6"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "ege_p_part1_menu"}))
    .get_json()
)

# ЕГЭ Профиль — Часть 1, задания 7–12
ege_p_part1b = (
    Keyboard(inline=True)
    .add(Callback("Задание 7",  {"cmd": "p7"}))
    .add(Callback("Задание 8",  {"cmd": "p8"}))
    .add(Callback("Задание 9",  {"cmd": "p9"}))
    .row()
    .add(Callback("Задание 10", {"cmd": "p10"}))
    .add(Callback("Задание 11", {"cmd": "p11"}))
    .add(Callback("Задание 12", {"cmd": "p12"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "ege_p_part1_menu"}))
    .get_json()
)
...
ege_p_part2 = (
    Keyboard(inline=True)
    .add(Callback("Задание 13", {"cmd": "p13"}))
    .add(Callback("Задание 14", {"cmd": "p14"}))
    .add(Callback("Задание 15", {"cmd": "p15"}))
    .row()
    .add(Callback("Задание 16", {"cmd": "p16"}))
    .add(Callback("Задание 17", {"cmd": "p17"}))
    .row()
    .add(Callback("Задание 18", {"cmd": "p18"}))
    .add(Callback("Задание 19", {"cmd": "p19"}))
    .row()
    .add(Callback("◀️ Назад", {"cmd": "ege_profile"}))
    .get_json()
)
...
export_menu_oge = (
    Keyboard(inline=True)
    .add(Callback("📄 PDF",              {"cmd": "export_variant_oge_pdf"}),          color=KeyboardButtonColor.PRIMARY)
    .add(Callback("📄 PDF с ответами",   {"cmd": "export_variant_oge_pdf_answers"}),  color=KeyboardButtonColor.PRIMARY)
    .row()
    .add(Callback("📝 DOCX",             {"cmd": "export_variant_oge_docx"}),         color=KeyboardButtonColor.SECONDARY)
...
export_menu_ege_base = (
    Keyboard(inline=True)
    .add(Callback("📄 PDF",              {"cmd": "export_variant_ege_base_pdf"}),          color=KeyboardButtonColor.PRIMARY)
    .add(Callback("📄 PDF с ответами",   {"cmd": "export_variant_ege_base_pdf_answers"}),  color=KeyboardButtonColor.PRIMARY)
    .row()
    .add(Callback("📝 DOCX",             {"cmd": "export_variant_ege_base_docx"}),         color=KeyboardButtonColor.SECONDARY)
...
export_menu_ege_profile = (
    Keyboard(inline=True)
    .add(Callback("📄 PDF",              {"cmd": "export_variant_ege_profile_pdf"}),          color=KeyboardButtonColor.PRIMARY)
    .add(Callback("📄 PDF с ответами",   {"cmd": "export_variant_ege_profile_pdf_answers"}),  color=KeyboardButtonColor.PRIMARY)
    .row()
    .add(Callback("📝 DOCX",             {"cmd": "export_variant_ege_profile_docx"}),         color=KeyboardButtonColor.SECONDARY)
