...
oge_n20 = (
    ...
    .row()
    .add(Callback("🎲 Случайное задание", {"cmd": "n20_random"}), color=KeyboardButtonColor.POSITIVE)
    .row()
    .add(Callback("◀️ Назад",             {"cmd": "back_to_tasks_oge"}))
    .get_json()
)
...
oge_n21 = (
    ...
    .row()
    .add(Callback("🎲 Случайное задание", {"cmd": "n21_random"}), color=KeyboardButtonColor.POSITIVE)
    .row()
    .add(Callback("◀️ Назад",             {"cmd": "back_to_tasks_oge"}))
    .get_json()
)
